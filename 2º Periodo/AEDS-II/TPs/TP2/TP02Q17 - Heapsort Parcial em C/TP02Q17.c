...
void insercaoPorCor( char titulo[][100], char tipo[][100], char Ids[][100], int n, int cor, int h){
    for (int i = (h + cor); i < n; i += h) {
        ...
        int j = i - h;
        while (j >= 0) {
            int cmpTipo = strcmp(tipo[j], tmpTipo);
            int cmpTitulo = strcmp(titulo[j], tmpTitulo);
...
void shellsort( char titulo[][100],char tipo[][100], char Ids[][100], int n) {
    int h = 1;
    while (h < n) h = (h * 3) + 1;
    ...
    do {
        ...
        for (int cor = 0; cor < h; cor++) {
            insercaoPorCor(tipo, titulo, Ids, n, cor, h);
        }
    } while (h != 1);
}
...
int main()
{
    ...
    while (strcmp(input, "FIM") != 0) {
        ...
        if (s != NULL) {
            ...
            strcpy(diretores[numTitulos], s->director);
            numTitulos++;
        } else {
    ...
    shellsort(diretores, Titulos, Ids, numTitulos);
