...
import '/pages/1_login/login_screen.dart';
import '/pages/2_signup/signup_screen.dart';
...
''';
  ...
  @override
  Widget build(BuildContext context) {
    // Usando o tema para pegar cores e estilos de texto
    final theme = Theme.of(context);

    return Scaffold(
      backgroundColor: theme.colorScheme.background,
      body: SafeArea(
        // ***** CORREÇÃO PRINCIPAL: Adicionado o SingleChildScrollView *****
        // Isso permite que a tela role se o conteúdo for muito grande.
        child: SingleChildScrollView(
          child: Padding(
            ...
            // A Column agora está dentro de uma área rolável
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.stretch,
              children: [
                // Adiciona um espaço no topo para não ficar colado
                const SizedBox(height: 48),

                // 1. Imagem/Ilustração
                Center(
                  // SVG ou sua imagem aqui
                  child: SvgPicture.string(rawSvg, width: 200, height: 200),
                ),
                const SizedBox(height: 48),
                ...
                Text(
                  'Venha fazer parte do melhor aplicativo de estudos do mercado.',
                  textAlign: TextAlign.center,
                  style: theme.textTheme.bodyLarge,
                ),
                const SizedBox(height: 48),

                // 3. Botões (agora dentro de uma Column)
                Column(
                  crossAxisAlignment: CrossAxisAlignment.stretch,
                  children: [
                    // Botão Register (Primário)
                    ElevatedButton(
                      style: theme.elevatedButtonTheme.style?.copyWith(
                        backgroundColor: MaterialStateProperty.all(AppColors.lightGrey),
                        foregroundColor: MaterialStateProperty.all(AppColors.textBase),
